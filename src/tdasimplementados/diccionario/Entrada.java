...
/**
 * Clase que implementa la interface IEntry y define el comportamiento de una entrada con dos datos de tipo genérico
 * @author Lucas Solmoni y Victoria Legakis

 * @param <K>  Tipo de las claves
 * @param <V> Tipo de los valores
 */
public class Entrada<K, V> implements IEntry<K, V> {
	private K clave;
	private V valor;
/**
