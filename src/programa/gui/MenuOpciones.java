...
public class MenuOpciones extends JFrame {
	...
	public MenuOpciones(Logica nuevoPrograma, String materia) {
		...
		ImageIcon auxBackground = new ImageIcon(
				MenuOpciones.class.getResource("/programa/gui/imgproject/abstract_background_8.png"));
		...
		ImageIcon barAux = new ImageIcon(MenuOpciones.class.getResource("/programa/gui/imgproject/descarga.jpg"));
		...
		ImageIcon auxTabs = new ImageIcon(MenuOpciones.class
				.getResource("/programa/gui/imgproject/103-1035002_may-your-holidays-be-dazzling-white-rectangle-with.png"));
		...
		ImageIcon auxIcon_1 = new ImageIcon(MenuOpciones.class.getResource(
				"/programa/gui/imgproject/vecteezy_isometric-flat-3d-illustration-concept-of-man-filling_21272478.png"));
		ImageIcon auxIcon_2 = new ImageIcon(MenuOpciones.class.getResource(
				"/programa/gui/imgproject/vecteezy_flat-3d-isometric-illustration-concept-of-educational-online_15593296.png"));
		ImageIcon auxIcon_3 = new ImageIcon(MenuOpciones.class.getResource(
				"/programa/gui/imgproject/vecteezy_isometric-flat-3d-concept-illustration-online-school-student_17310931.png"));
		...
		lblNewLabel_4_2.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				...
				lblNewLabel.setVisible(false);
				model.setRowCount(0);
				for (Pair<Integer, Integer> pair : programa.visualizarAlumnos()) {
		...
		ImageIcon btnAux = new ImageIcon(MenuOpciones.class.getResource("/programa/gui/imgproject/g20154.png"));
		...
		textField_2.setToolTipText("Ingrese el L.U.");
		textField_2.setFont(new Font("Century Gothic", Font.PLAIN, 11));
		textField_2.setBounds(81, 89, 241, 31);
		...
		btnNewButton_1_1.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				String luAux = textField_2.getText();
				textField_2.setText("");
		...
		textField.setBounds(81, 54, 241, 31);
		panel_4.add(textField);

		textField_1 = new JTextField();
		textField_1.setColumns(3);
		textField_1.setBorder(null);
		textField_1.setToolTipText("Ingrese una nota del 0 al 10.");
		textField_1.setFont(new Font("Century Gothic", Font.PLAIN, 11));
		textField_1.setBounds(81, 126, 241, 31);
		...
		btnNewButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				String notaAux = textField_1.getText();
				textField.setText("");
				textField_1.setText("");
				if (chequearDatosVacios(luAux, notaAux)) {
					if (chequearEntero(luAux) && chequearEntero(notaAux)) {
						lu = Integer.valueOf(luAux);
						...
						if (chequearNota(nota) && !chequearLU(lu)) {
							...
							AlumnoIngresado alumnoInvalido2 = new AlumnoIngresado(false, 2);
							alumnoInvalido2.setTitle("Registro de Alumnos de " + materia);
							alumnoInvalido2.setVisible(true);	
						}
		...
		ImageIcon btnAux1 = new ImageIcon(MenuOpciones.class.getResource("/programa/gui/imgproject/abstract_background_5.png"));
		...
		ImageIcon icoDecoAux = new ImageIcon(MenuOpciones.class.getResource(
				"/programa/gui/imgproject/vecteezy_flat-isometric-illustration-concept-pile-of-books-and-ideas_6202279.png"));
		...
		ImageIcon btnAux2 = new ImageIcon(MenuOpciones.class.getResource("/programa/gui/imgproject/g20154.png"));
		ImageIcon btnAux3 = new ImageIcon(MenuOpciones.class.getResource("/programa/gui/imgproject/g20154.png"));
		ImageIcon btnAux4 = new ImageIcon(MenuOpciones.class.getResource("/programa/gui/imgproject/g20154.png"));
		...
		ImageIcon icoDecoAux1 = new ImageIcon(MenuOpciones.class.getResource(
				"/programa/gui/imgproject/vecteezy_concept-illustration-of-isometric-female-student-riding-a_9160122.png"));
		...
		ImageIcon backAux = new ImageIcon(MenuOpciones.class.getResource("/programa/gui/imgproject/abstract_background_8.png"));
		...
		ImageIcon backAux1 = new ImageIcon(MenuOpciones.class.getResource("/programa/gui/imgproject/abstract_background_8.png"));
	...
	private boolean chequearNota(int entero) {
