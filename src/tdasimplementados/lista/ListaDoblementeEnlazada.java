...
/**
 *Clase que define una lista doblemente enlazada con elementos de tipo genérico e implementa la interfaz IPositionList
 ...
 */
	...
	@Override
	public IPosition<E> next(IPosition<E> sig) throws InvalidPositionException, BoundaryViolationException {
	...
	@Override
	public IPosition<E> prev(IPosition<E> sig) throws InvalidPositionException, BoundaryViolationException {
		DNodo<E> nodo = checkPosition(sig);
 ...
 */
	...
	@Override
	public E set(IPosition<E> p, E elm) throws InvalidPositionException {
	...
	@Override
	public void addBefore(IPosition<E> p, E item) throws InvalidPositionException {
	...
	@Override
	public void addAfter(IPosition<E> p, E item) throws InvalidPositionException {
		DNodo<E> nodo = checkPosition(p); // el caso cuando es la head ya esta en checkposition
		if (isEmpty()) {
			throw new InvalidPositionException("Lista vacia.");
		}
	...
	public Iterable<IPosition<E>> positions() {
		IPositionList<IPosition<E>> toReturn = new ListaDoblementeEnlazada<>();
   ...
   */
	private class DNodo<E> implements IPosition<E> {
		private E element;
