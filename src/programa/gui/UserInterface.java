...
public class UserInterface {
	...
	private void initialize() {
		...
		ImageIcon btnVolverAux = new ImageIcon(UserInterface.class.getResource("/programa/gui/imgproject/1177531.png"));
		...
		ImageIcon imgAuxButton = new ImageIcon(UserInterface.class.getResource("/programa/gui/imgproject/1177527.png"));
		...
		ImageIcon imgAux = new ImageIcon(UserInterface.class.getResource("/programa/gui/imgproject/abstract_background_5.png"));
		...
		nuevoPrograma = new Logica(txtIngreseElNombre.getText());
